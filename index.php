...
<div class="user_details column">
    ...
    foreach($friends_array as $friend) {
        echo "<div class='friends_details_left_right'>
                   <p>Friends</p>
                   <div class='user_info'>
                   <a href='".$friend['username']."'><img src='" . $friend['profile_pic'] . "'</a>
                   <a href='".$friend['username']."'>" . $friend['first_name'] . " " . $friend['last_name'] . "</a>
                   </div>
              </div>";
        }
    ?>
