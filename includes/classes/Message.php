...
class Message {
	...
	public function getMessages($otherUser) {
			...
			$get_messages_query = mysqli_query($this->con, 
	...
	public function getConvosDropdown($data, $limit) {
		...
		if($count > $limit) 
			$return_string .= "<input type='hidden' class='nextPageDownData' value='".($page + 1)."'><input type='hidden' class='noMoreDropdownData' value='false'>";
		else
